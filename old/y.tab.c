...
{
       0,   105,   105,   150,   156,   158,   160,   162,   168,   173,
     175,   177,   182,   184,   186,   188,   190,   192,   194,   196,
     198,   203,   208,   213
};
#endif
...
{
       0,   -12,    14,    14,    -4,   -14,   -14,   -14,   -14,   -14,
     -14,   -14,    14,    11,     9,    41,   -14,   -14,   -14,   -14,
     -14,    16,    46,    29,     9,   -14,    28,   -14,   -14,   -14,
     -14,    41
};
...
{
       0,     0,     8,     8,     0,    19,    20,    14,    16,    18,
      15,    17,     8,     0,     2,     4,     9,    12,    13,    11,
       3,     0,     0,     0,     6,     1,     5,    10,    22,    21,
      23,     7
};
...
{
      -8,     1,    27,     2,    20,     3,    23,     4,     5,     6,
       7,    25,     8,     9,    10,    11,    12,     2,    27,     3,
      28,     4,     5,     6,     7,    26,     8,     9,    10,    11,
      12,     2,    26,     3,     3,     4,     5,     6,     7,    31,
       8,     9,    10,    11,     2,    30,     3,    21,    22,     5,
       6,     7,    29,     8,     9,    10,    11,    24,     0,     0,
       0,     0,    26
};

static const yytype_int8 yycheck[] =
{
       0,     1,    15,     3,    16,     5,    10,     7,     8,     9,
      10,     0,    12,    13,    14,    15,    16,     3,    31,     5,
       4,     7,     8,     9,    10,    16,    12,    13,    14,    15,
      16,     3,    16,     5,     5,     7,     8,     9,    10,    26,
      12,    13,    14,    15,     3,    23,     5,     2,     3,     8,
       9,    10,     6,    12,    13,    14,    15,    12,    -1,    -1,
      -1,    -1,    16
};
...
#line 213 "grammar.y" /* yacc.c:1646  */
    {
            ...
            if (def->type->tag != V_ERROR) {
                ...
                add_info(def->type->content.err, "in definition of function %s", (yyvsp[0].n));
            }
